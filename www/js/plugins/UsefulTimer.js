...
UsefulTimer.param.date_day_sun       = String(UsefulTimer.parameters['Date Day Sun'] || 'Sun');
UsefulTimer.param.date_day_mon       = String(UsefulTimer.parameters['Date Day Mon'] || 'Mon');
UsefulTimer.param.date_day_tue       = String(UsefulTimer.parameters['Date Day Tue'] || 'Tue');
UsefulTimer.param.date_day_wed       = String(UsefulTimer.parameters['Date Day Wed'] || 'Wed');
UsefulTimer.param.date_day_thu       = String(UsefulTimer.parameters['Date Day Thu'] || 'Thu');
UsefulTimer.param.date_day_fri       = String(UsefulTimer.parameters['Date Day Fri'] || 'Fri');
UsefulTimer.param.date_day_sat       = String(UsefulTimer.parameters['Date Day Sat'] || 'Sat');
