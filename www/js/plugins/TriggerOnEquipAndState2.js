...
(function() {
    ...
    Game_Actor.prototype.controlVariable = function(item, addedSign, indexString) {
        ...
        if (variableTarget) {
            ...
            var originalValue = $gameVariables.getOriginalValue ? $gameVariables.getOriginalValue(variableId) : $gameVariables.value(variableId); $gameTemp.reserveCommonEvent(12);  //追加
